...
- како да дозволимо компајлеру да сâм (имплицитно) конвертује целе бројеве у разломке,
...
начин као и са целим и реалним бројевима. На пример:
...
Да бисмо подржали и изразе попут ``a - 3`` или ``2 * a``, можемо да напишемо и ове методе: 
...
ситуацију помоћу имплицитне конверзије.
...
.. comment
    ...
    .. reveal:: staticki_polimorfizam
        ...
        **Зашто је овај полиморфизам статички**
        ...
        конкретном методу. Касније ћемо видети да постоји и динамички полиморфизам, где компајлер 
