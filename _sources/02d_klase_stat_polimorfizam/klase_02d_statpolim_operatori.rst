...
Ипак, за прогамера који користи нашу класу би било удобније да може да рачуна са разломцима на исти 
...
Језик *C#* подржава могућност да дефинишемо оператор сабирања и за објекте ило које наше класе. 
...
написали на овај начин (користећи скраћивање) да бисмо смањили моућност да дође до прекорачења 
...
прилагоди типове праметара неком од постојећих метода са тим именом. Тако се целобројно 2 
...
Следи пример са **комплетном класом** ``Razlomak``, који омогућава учитавање разломака са 
тастатуре, приказ на екрану, поређење и рачунање са разломцима. Пример можете да копирате и 
испробате у свом радном окружењу.
...
.. comment
    ...
    .. reveal:: staticki_polimorfizam
        ...
        **Зашто је овај полиморфизам статички**
        ...
        Овај тип полиморфизма називамо статички, јер читајући изворни код компајлер на сваком месту 
