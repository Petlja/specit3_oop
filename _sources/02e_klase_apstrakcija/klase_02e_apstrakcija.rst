...
бира те-ве канале. Могућност детаљније контроле телевизора га само збуњује и отежава му употребу 
даљинског управљача.
...
.. topic:: Индексер
    ...
    поље објекта, док се индекс примењује на сам објекат. Тачније, индексер нам омогућава да 
    ...
    Наредбом ``ds[3] = 7;`` се извршава приступник ``set`` индексера, док писање ``ds[3]`` у 
...
.. suggestionnote::
    ...
    и даје исти резултат као и пре измене (ако не ради, то значи да Жељко није добро одрадио свој 
...
(сразмерно лограритму дужине низа, уместо да буде константно). 
