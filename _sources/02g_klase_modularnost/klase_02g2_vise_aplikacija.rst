...
за конзолну апликацију. Такође, на почетак проргама треба да додамо ред ``using AsocijacijeLib;``, 
...
Дволиком на форму, добијамо метод ``Form1_Load`` који ћемо касније да искористимо за све потребне 
...
закључи које параметре да проследи метиду игре ``igra.Otvori(kol, polje)``. Ипак, пошто упоређивање 
