...
- Апстрактни типови податка и њигова веза са генеричким класама
...
.. reveal:: pre_generickih_klasa
    ...
    **Још неке добре стране генеричких класа:**
    ...
    - **безбедност типова** (енгл. `type safety`), јер се слагање типова при операцијама код 
      генеричких класа проверава статички, тј. у веме компајлирања. Ово је у случају генеричких 
    ...
    - **боље перформансе** у односу на решења са општим објектима. Употребом генеричких класа 
      извегава се потреба за конверзијом променљивих простог типа у објекте (тзв. боксовање, енгл. 
