...
.. questionnote::
    ...
    **Пример**: Написати генеричку класу ``CollectionWihCursor<T>``, која симулира колекцију 
    ...
    Написати и прогам који демонстрира функционалност класе.
...
.. suggestionnote::
    ...
    **О редукцији интерфејса:**
    ...
    - **да олакша касније побољшавање имплементације**, јер сакривањем непотребних делова 
      класе употребљене у имплементацији остаје мање метода које треба подржати у новој 
...
одлучили за другачије решење, а имплементација класе ``CollectionWihCursor`` помоћу класе 
