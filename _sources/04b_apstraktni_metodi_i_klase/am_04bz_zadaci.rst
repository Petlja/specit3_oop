...
.. questionnote::
    ...
    **1. Телефонски претплатници**
    
    Написати класу ``TelefonskiPretplatnik``, која садржи податке о особи, број телефона, евиденцију 
    о обављеним разговорима и објекат класе ``TarifniPaket``, који на основу евиденције позива 
    израчунава износ рачуна. Класа ``TarifniPaket`` има више изведених класа (на пример ``Pripejd`` и 
    ``Postpejd``). Могуће је различито тарифирати разговоре у истој и различитој мрежи, домаћи и инострани саобраћај и слично. 
