...
.. questionnote::
    ...
    **2. Роботи** Четири типа робота могу да се крећу по бинарној матрици, у којој нуле представљају 
    ...
    на коме се налаази робот након извршења команди.
    ...
    Пробрам би био комплетнији када би омогућио задавање матрице, као и низа команди, а могао би и да 
...
.. questionnote::
    ...
    **3. Банковни рачун** У зависности од количине расположивог новца на рачуну, банка може 
    ...
    Твој задатак је да допуниш доле започети програм писањем апстрактне класе ``RacunSaStatusom`` 
...
.. collapse:: Упутство
    ...
    Ако до сада ниси, пажљиво проучи пример "Продајни аутомат" из ове лекције. Решење овог задатка 
