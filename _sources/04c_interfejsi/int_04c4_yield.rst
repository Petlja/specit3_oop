...
односно припреме за итерирање кроз колекцију коју генерише метод ``f()``.

Рекурзивни методи који генеришу колекције
-----------------------------------------

Метод који генерише колекцију може у свој резултат да укомпонује резултате других метода који 
...
``Main`` овај параметар има вредност `k`, а у каснијим позивима се смањује. Трећи параметар 
је највећа дозвољена цифра `m`.
...
У последњем примеру овог прилога илустроваћемо графичко решење познатог `проблема ханојских 
